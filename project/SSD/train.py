...
def start_train(cfg):
    ...
    scheduler = StepLR(optimizer, step_size=500000, gamma=0.9)
    ...
    train_loader = make_data_loader(cfg, is_train=True, augment=True, max_iter=max_iter, start_iter=arguments['iteration'])
