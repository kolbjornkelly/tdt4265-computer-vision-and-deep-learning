...
def make_data_loader(cfg, is_train=True, augment=False, max_iter=None, start_iter=0):
    ...
    if shuffle:
        ...
        sampler = torch.utils.data.sampler.SequentialSampler(datasets)
    ...
    data_loader = DataLoader(datasets, num_workers=cfg.DATA_LOADER.NUM_WORKERS, batch_sampler=batch_sampler,
